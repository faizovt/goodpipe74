		<?php 
			$title = "Труба полипропиленовая армированная для отопления PN25 (алюминий) D32x5400 - Хорошие Трубы";
			include '../../../../header.php';
		?>
				...
				<div class="products-product">
					<div class="row">
						<div class="breadcrumbs">
							<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/heating">Трубы для отопления</a> <span class="breadcrumbs-arrow">></span> <a href="/products/heating/aluminum">Трубы для отопления армированные алюминием</a> <span class="breadcrumbs-arrow">></span> <span>Труба PN25 (алюминий) D32x5400</span>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__img"><img src="/img/products/img-product-heating-aluminium.jpg" alt=""></div>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая армированная для отопления PN25 (алюминий) D32x5400</div>

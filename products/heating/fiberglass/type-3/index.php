		<?php 
			$title = "Труба полипропиленовая армированная для отопления PN25 (стекловолокно) D32x5400 - Хорошие Трубы";
			include '../../../../header.php';
		?>
				...
				<div class="products-product">
					<div class="row">
						<div class="breadcrumbs">
							<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/heating">Трубы для отопления</a> <span class="breadcrumbs-arrow">></span> <a href="/products/heating/fiberglass">Трубы для отопления армированные стекловолокном</a> <span class="breadcrumbs-arrow">></span> <span>Труба PN25 (стекловолокно) D32X5400</span>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__img"><img src="/img/products/img-product-heating-fiberglass.jpg" alt=""></div>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая армированная для отопления PN25 (стекловолокно) D32x5400</div>
							<div class="products-product__text">
								...
								<div class="products-product__text-length">
									<span>Длина:</span> 5400 мм (5,4 м) <br>
								</div>
								<div class="products-product__text-price">
									<span>Цена:</span> 210 руб.
								</div>
							</div>

		<?php 
			$title = "Труба полипропиленовая для холодного водоснабжения PN10 D20x1900 - Хорошие Трубы";
			include '../../../../header.php';
		?>
				...
				<div class="products-product">
					<div class="row">
						<div class="breadcrumbs">
							<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/water">Водопроводные трубы</a> <span class="breadcrumbs-arrow">></span> <a href="/products/water/cold">Трубы для холодной воды</a> <span class="breadcrumbs-arrow">></span> <span>Труба PN10 D20x1900</span>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__img"><img src="/img/products/img-product-water-cold.jpg" alt=""></div>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая для холодного водоснабжения PN10 D20x1900</div>
							<div class="products-product__text">
								...
								<div class="products-product__text-length">
									<span>Длина:</span> 1900 мм (1,9 м) <br>
								</div>
								<div class="products-product__text-price">
									<span>Цена:</span> 49 руб.
								</div>
							</div>

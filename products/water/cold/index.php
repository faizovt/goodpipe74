		<?php 
			$title = "Трубы для холодного водоснабжения - Хорошие Трубы";
			include '../../../header.php';
		?>
		...
		<section class="products">
			<div class="container">
				...
				<div class="breadcrumbs">
					<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/water">Водопроводные трубы</a> <span class="breadcrumbs-arrow">></span> <span>Трубы для холодной воды</span>
				</div>
				<div class="products-blocks">
					<div class="products-block">
						<a href="type-1/">
							...
							<div class="products-block__text">Труба полипропиленовая<br>PN10 D20x1900</div>
						</a>
					</div>
					<div class="products-block">
						<a href="type-2/">
							...
							<div class="products-block__text">Труба полипропиленовая<br>PN10 D25x2300</div>
						</a>
					</div>
					<div class="products-block">
						<a href="type-3/">
							...
							<div class="products-block__text">Труба полипропиленовая<br>PN10 D32x2900</div>
						</a>
					</div>
				</div>
			</div>

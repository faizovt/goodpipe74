		<?php 
			$title = "Труба полипропиленовая для холодного водоснабжения PN10 D25x2300 - Хорошие Трубы";
			include '../../../../header.php';
		?>
				...
				<div class="products-product">
					<div class="row">
						<div class="breadcrumbs">
							<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/water">Водопроводные трубы</a> <span class="breadcrumbs-arrow">></span> <a href="/products/water/cold">Трубы для холодной воды</a> <span class="breadcrumbs-arrow">></span> <span>Труба PN10 D25x2300</span>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__img"><img src="/img/products/img-product-water-cold.jpg" alt=""></div>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая для холодного водоснабжения PN10 D25x2300</div>
							<div class="products-product__text">
								...
								<div class="products-product__text-length">
									<span>Длина:</span> 2300 мм (2,3 м) <br>
								</div>

		<?php 
			$title = "Труба полипропиленовая канализационная наружная D110x1000 - Хорошие Трубы";
			include '../../../../header.php';
		?>
				...
				<div class="products-product">
					<div class="row">
						<div class="breadcrumbs">
							<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/sewage">Канализационные трубы</a> <span class="breadcrumbs-arrow">></span> <a href="/products/sewage/outside">Трубы для наружной канализации</a> <span class="breadcrumbs-arrow">></span> <span>Труба канализационная (наружная) D110x1000</span>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__img"><img src="/img/products/img-product-sewage-outside.jpg" alt=""></div>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая канализационная наружная D110x1000</div>
							<div class="products-product__text">
								...
								<div class="products-product__text-diameter">
									<span>Диаметр:</span> 110 мм <br>
								</div>
								<div class="products-product__text-length">
									<span>Длина:</span> 1000 мм (1,0 м) <br>
								</div>

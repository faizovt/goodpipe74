		<?php 
			$title = "Труба полипропиленовая канализационная наружная D160x2000 - Хорошие Трубы";
			include '../../../../header.php';
		?>
			...
			<div class="container">
				<div class="products-product">
					<div class="row">
						...
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая канализационная наружная D160x2000</div>
							<div class="products-product__text">
								...
								<div class="products-product__text-diameter">
									<span>Диаметр:</span> 160 мм <br>
								</div>
								<div class="products-product__text-length">
									<span>Длина:</span> 2000 мм (2,0 м) <br>
								</div>
								<div class="products-product__text-price">
									<span>Цена:</span> 249 руб.
								</div>
							</div>

		<?php 
			$title = "Трубы для внутренней канализации - Хорошие Трубы";
			include '../../../header.php';
		?>
		...
		<section class="products">
			<div class="container">
				...
				<div class="breadcrumbs">
					<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/sewage">Канализационные трубы</a> <span class="breadcrumbs-arrow">></span> <span>Трубы для внутренней канализации</span>
				</div>
				<div class="products-blocks">
					<div class="products-block">
						<a href="type-1/">
							...
							<div class="products-block__text">Труба канализационная<br>внутренняя D32x150</div>
						</a>
					</div>
					<div class="products-block">
						<a href="type-2/">
							...
							<div class="products-block__text">Труба канализационная<br>внутренняя D50x500</div>
						</a>
					</div>
					<div class="products-block">
						<a href="type-3/">
							...
							<div class="products-block__text">Труба канализационная<br>внутренняя D110x1000</div>
						</a>
					</div>
				</div>
			</div>

		<?php 
			$title = "Труба полипропиленовая канализационная для внутренних помещений D32x150 - Хорошие Трубы";
			include '../../../../header.php';
		?>
				...
				<div class="products-product">
					<div class="row">
						<div class="breadcrumbs">
							<a href="/">Главная</a> <span class="breadcrumbs-arrow">></span> <a href="/products">Продукция</a> <span class="breadcrumbs-arrow">></span> <a href="/products/sewage">Канализационные трубы</a> <span class="breadcrumbs-arrow">></span> <a href="/products/sewage/inside">Трубы для внутренней канализации</a> <span class="breadcrumbs-arrow">></span> <span>Труба канализационная (внутренняя) D32x150</span>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__img"><img src="/img/products/img-product-sewage-inside.jpg" alt=""></div>
						</div>
						<div class="col-12 col-lg-6">
							<div class="products-product__title">Труба полипропиленовая канализационная для внутренних помещений D32x150</div>
							<div class="products-product__text">
								...
								<div class="products-product__text-length">
									<span>Длина:</span> 150 мм (0,15 м) <br>
								</div>
								<div class="products-product__text-price">
									<span>Цена:</span> 80 руб.
								</div>
							</div>
